...
const InviteCard: React.FC<InviteCardProps> = ({ title, profit }) => {
  return (
    <div className="customCard-container grid grid-col-1 grid-col-1 w-full">
      <div className="customCard flex justify-start gap-2 group px-2 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0 -8px 0px 0px #2196f3]">
        <img
          src="gift.svg"
          alt=""
          className="w-12 h-12"
