...
const FriendCard: React.FC<FriendCardProps> = ({
  ...
  return (
    <div className="customCard-container right-skew grid grid-col-1  grid-col-1 w-full">
      <div className="customCard right-skew group rounded-[10px] p-2 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0 -8px 0px 0px #2196f3] flex justify-between">
