...
const Friends = ({ user }: { user: any }) => {
  ...
  const handleClipBoardCopy = async () => {
    legacyCopy(`
https://t.me/BLEGGSBot/BLEGGSMiniApp/start?startapp=${inviteLink}
${desText}`);
  ...
  return (
    <div className="pb-[40px]">
      ...
      <div className={`absolute customCard-container flex flex-col w-full md:w-[400px] md:mx-auto right-0 text-white px-4 py-2 pb-8 gap-4 transition-all duration-500 ease-out transform ${showModal ? 'bottom-[40px]' : 'bottom-[-400px]'}`}>
        ...
        <a href={`https://t.me/share/url?url=https://t.me/BLEGGSBot/BLEGGSMiniApp/start?startapp=${inviteLink}&text=${desText}`} target="blank" className="customCard-container p-[4px] rounded-full text-white hover:text-white">
