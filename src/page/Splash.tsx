  ...
  return (
    <div className='flex flex-col justify-between h-full pt-4'>
      <div className='w-full h-3/5'>
        <img src='splash.png' className='w-full h-full'></img>
      </div>
      <div className='flex flex-col px-[20px] justify-between gap-[2rem] pt-[2rem] pb-[2rem]'>
        <span className='text-[24px] text-justify [text-align-last:justify]'>
          Claim your 100, 000 $Buffy
        </span>
        <span className='text-[18px] text-justify [text-align-last:justify]'>
          You're our 100,000th member! Bring your friends onboard and unlock
          even more rewards from their success!
        </span>
        <button className='bg-blue-700' onClick={() => setTab('Exchange')}>
          Claim Buffy
        </button>
      </div>
